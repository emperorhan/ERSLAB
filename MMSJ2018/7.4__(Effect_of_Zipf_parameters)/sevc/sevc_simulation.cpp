...
string GetInputFileName(double theta){
	return "SEVC_zipf_poisson___(THETA=" + to_string(theta) + ").txt";
}

string GetOutputFileName(double theta, int ssdBand){
	return "SEVC_zipf_Disk_bandwidth_saved___(THETA=" + to_string(theta) + "_ssdBandwidth=" + to_string(ssdBand) + "KB).txt";
}
...
int main(int argc, char* argv[]) {
	...
	int ssdSize = ssdSizeArr[ssdSizeIdx];
	...
	freopen(GetOutputFileName(theta, MAX_SSD).c_str(), "w+", stdout);
